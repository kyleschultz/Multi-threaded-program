...
def generate_data(exe):
    ...
    for req in range(1, 10):
        for res in range(1, 10):
            ...
            file1 = "input/names1.txt"
            file2 = "input/names2.txt"
            file3 = "input/names3.txt"
            file4 = "input/names4.txt"
            file5 = "input/names5.txt"
            parameters = "%s %s" % (req, res)
            call_arguments = str("""["%s", "%s", "%s", "serviced.txt", "results.txt", "%s", "%s","%s","%s","%s"]""" % ("./"+str(exe), req, res, file1, file2, file3, file4, file5))
